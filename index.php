...
.clockdate-wrapper {
    ...
    background: -webkit-linear-gradient(to right, #365ccd, #141E30);  /* Chrome 10-25, Safari 5.1-6 */
    background: linear-gradient(to right, #365ccd, #141E30); /* W3C, IE 10+/ Edge, Firefox 16+, Chrome 26+, Opera 12+, Safari 7+ */
    padding:17px;
    max-width:260px;
    width:100%;
    text-align:center;
...
@media (max-width: 500px){
  .clockdate-wrapper { position: relative; margin-bottom: 30px; max-width: 200px;}
  ...
  SJC
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" style="color: white; font-size: 20px;" href="index.php" data-toggle="collapse" data-target="#collapseTwo"
                    aria-expanded="true" aria-controls="collapseTwo">
                    <i style="color: white; font-size: 20px;" class="fas fa-user"></i>
                    <span>STUDENT</span>
                </a>
