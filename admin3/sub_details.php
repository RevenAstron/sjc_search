...
<div class="modal-header">
        <h5 class="modal-title fs-5" id="exampleModalLabel">Subject Details</h5>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <form action="sub_edit.php" method="POST">
                            <input type="hidden" name="edit_subc" value="<?php echo $row['sub_code'];?>">
    ...
    <div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Delete Subject data </h5>
