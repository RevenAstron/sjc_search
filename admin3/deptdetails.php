...
<div class="modal-header">
        <h5 class="modal-title fs-5" id="exampleModalLabel">Department Details   &#160<a style="margin-left: 15px;" href="programadd.php">Add new department</a></h5>
                ...
                <tr>
                    ...
                    <td>
                        <form action="deptedit.php" method="post">
                            <input type="hidden" name="edit_dcode" value="<?php echo $row['DCODE'];?>">
